...
namespace AutoCar.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260603235320_CadastroOrdemServico")]
    partial class CadastroOrdemServico
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoCar.Domain.Entities.OrdemServico", b =>
                {
                    ...
                    b.Property<Guid?>("IdUsuarioMecanico")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AutoCar.Domain.Entities.OrdemServico", b =>
                {
                    ...
                    b.HasOne("AutoCar.Domain.Entities.Usuario", null)
                        .WithMany()
                        .HasForeignKey("IdUsuarioMecanico")
                        .OnDelete(DeleteBehavior.Restrict);
