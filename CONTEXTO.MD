...
1. **Aplicação por veículo** (montadora/modelo/ano — texto livre no MVP): vincular ao Produto para
   o catálogo automotivo.
...
5. (dívida) Paginação na listagem de Produto quando o volume crescer (hoje sem `Take`/`Skip`,
